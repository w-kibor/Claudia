    ...
    try {
      ...
      if (result.success && result.data?.response) {
        ...
        setMessages((prev) => [
          ...
          {
            role: 'assistant',
            content: result.message || 'Sorry, I encountered an issue getting that answer.',
          },
        ]);
      }
    } catch (error) {
      const errMessage =
        error instanceof Error ? error.message : 'I had trouble connecting to my cloud kitchen.';
      setMessages((prev) => [
        ...prev,
        {
          role: 'assistant',
          ...
          >
            ...
            <div className='relative h-48 sm:h-64 md:h-80 flex-shrink-0'>
              ...
              <div className='absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6'>
                <h1 className='text-2xl sm:text-3xl md:text-4xl font-semibold mb-2 line-clamp-2'>
                  {recipe.name}
                </h1>
            ...
            <div
              className='absolute bottom-0 left-0 right-0 bg-card border-t border-border flex flex-col backdrop-blur-md'
            ...
            >
              ...
              <div className='p-3 sm:p-4 bg-card'>
                <div className='flex items-center gap-2 mb-2'>
                  <div
                    className={`w-2 h-2 rounded-full ${isThinking ? 'bg-amber-500 animate-pulse' : 'bg-accent'}`}
                  />
